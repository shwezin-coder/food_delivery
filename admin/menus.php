                        ...
                        <?php 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="flex mt-3">
                                        <button class="btn btn-primary editbtn" data-toggle="modal" data-target="#editModal" data-menu='<?php echo json_encode($row_menu); ?>'>Update Image</button>
                                        <button class="btn btn-danger deletebtn" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $row_menu['id']; ?>">Feature Images</button>
                                    </div>
                                </td>
                            </tr>
                            <?php
